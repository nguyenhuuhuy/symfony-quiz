...
use Acme\ReqBundle\Entity\QuizQuestionsRelations;
use Exception;
...
class QuizPaginationRecordHelper
{
    ...
    /**
     * @return \Acme\ReqBundle\Model\Quiz\QuizQuestionsRelations $pagingRecord
     */
    ...
    /**
     * 
     * @param \Acme\ReqBundle\Model\Quiz\QuizAnswersGetterWrapper $wrapper
     * @return array
     */
    ...
    /**
     * @param \Acme\ReqBundle\Model\Quiz\QuizQuestionsGetterWrapper $wrapper
     * @return array
     */
    ...
    /**
     * @param \Acme\ReqBundle\Model\Quiz\QuizTagsGetterWrapper $wrapper
     * @return array|null
     */
